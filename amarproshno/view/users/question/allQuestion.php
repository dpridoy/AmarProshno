                                ...
                                <div class="media" style="margin-top: 20px">
                                    <div class="media-left media-top">
                                        <?php if(isset($data['photo'])):?>
                                            <a href="../information.php" ><img src="../<?php echo $data['photo']; ?>" atl="image" width="40px" height="40px"></a>
                                        <?php else:?>
                                            <a href="../information.php" ><img src="../../../assests/img/users_image.jpg" atl="image" width="40px" height="40px"></a>
                                        <?php endif;?>
                                    </div>
