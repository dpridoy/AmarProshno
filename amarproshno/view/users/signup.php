        ...
        <div class='container-fluid' style="margin-top: 100px">
            <div class='login-form form facile-color-blue' >
                ...
                <form action="registerstore.php" method="post">
                    ...
                    <div class='form-group' >
                        <div class='facile-icon-input facile-button-input' >
                            <input type='password' name="cpassword" placeholder='*********' class='facile-text' >
                            <?php if(isset($_SESSION['cpassword'])):?>
                                <p class="text-danger" style="margin-top: 15px">
                                    <?php echo $_SESSION['cpassword'];
                    ...
                    <div class='form-group' >
                        <button type='submit' class='facile-btn btn-block' >Next Step</button>
                    </div>
                </form>
                <p>Already have an account? <a href="login.php" class="text-success">Log In</a></p><br>
            </div>
        </div>
    </div>
